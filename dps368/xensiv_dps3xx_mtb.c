                                             ...
                                             uint8_t reg_addr, uint8_t* data, uint8_t length)
{
    ...
    return rc;*/
	return hal_i2c_read_register(i2c_addr, reg_addr, data, length);
}
...
//    }
//    return rc;
	return hal_i2c_write_register(i2c_addr, reg_addr, data, length);
}
...
//--------------------------------------------------------------------------------------------------
cy_rslt_t xensiv_dps3xx_mtb_init_i2c(xensiv_dps3xx_t* dev, xensiv_dps3xx_i2c_addr_t i2c_addr)
{
